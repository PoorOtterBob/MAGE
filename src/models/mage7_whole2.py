...
class MAGE(BaseModel):
    def __init__(self, model_args, **args):
        ...
        self.backbone2 = Pre_Norm_Transformer(self.args.model_dim, self.args.recur_num//2, self.node_num, blocknum=2)
        self.backbone3 = Pre_Norm_Transformer(self.args.model_dim, self.args.recur_num//4, self.node_num, blocknum=3)
