...
class SwiGLU_FFN(nn.Module):
    def __init__(self, dim_in, dim_out, expand_ratio=4, dropout=0.3):
        ...
        self.W1 = nn.Linear(dim_in, expand_ratio*dim_in, bias=False)
        self.W2 = nn.Linear(dim_in, expand_ratio*dim_in, bias=False)
        self.W3 = nn.Linear(expand_ratio*dim_in, dim_out, bias=False)
...
class Lowrank_Spattention(nn.Module):
    def __init__(self, dim, dim_attn, rank, head=4):
        ...
        self.query = nn.Linear(dim, dim_attn, bias=False)
