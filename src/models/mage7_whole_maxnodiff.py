...
class MAGE_Block(nn.Module):
    def __init__(self, dim, expert_num, node_num, depth, model_dim, graph_gen_dim=32, head=4, topk=4):
        ...
        # Differential
        self.E1 = nn.Parameter(torch.rand(expert_num, node_num, graph_gen_dim))
        self.E2 = nn.Parameter(torch.rand(expert_num, graph_gen_dim, node_num))
    ...
    def forward(self, x, bias):
        ...
        x = torch.einsum('bik, kid, kdj, bjf, fc -> bic', 
                         route,
